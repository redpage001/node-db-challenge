...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
        ...
        A 'relational database' is a database where data is stored as tables and 'SQL' is a query language that queries a database, which is optimized for writing queries and retrieving data.

- [ ] Why do tables need a `primary key`?

        A 'primary key' is used to identify each entry in a table uniquely.

- [ ] What is the name given to a table column that references the primary key on another table.

        The name for that kind of table column is 'foreign key'.

- [ ] What do we need in order to have a _many to many_ relationship between two tables.

        You need to have multiple entries in a table to be associated with multiple entriess within another table.
